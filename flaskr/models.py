...
class User(UserMixin, db.Model):
    ...
    def __init__(self, **kwargs):
        ...
        and if after that the object does not have a role defined, it sets the 
        administrator or default role depending on the email address.
        '''
...
class Post(db.Model):
    ...
    from the User model. The body field is defined with type db.Text so that there 
